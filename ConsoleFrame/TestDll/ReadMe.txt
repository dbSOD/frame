...
应用程序向导已为您创建了此 TestDll DLL。此 DLL 不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写 DLL 的起点。

本文件概要介绍组成 TestDll DLL 的每个文件的内容。
...
TestDll.h
    这是 DLL 的主头文件。它声明了 CTestDllApp 类。

TestDll.cpp
    这是主 DLL 源文件。它包含 CTestDllApp 类。
